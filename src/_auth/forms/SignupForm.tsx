  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">to use Socialviewer, please enter your details</p>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormControl>
                <Input type='text'className='shad-input mt-2' {...field} />
              </FormControl>
